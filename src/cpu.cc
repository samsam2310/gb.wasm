...
int CPU::executeCBInst_(uint8_t op) {
  ...
  switch (op) {
    ...
    case 0x76:
    case 0x7E:
      bit(mem_->read(reg_.hl), (op >> 3) & 0x7, &reg_.f);
      return 12;
    case 0x47:
    case 0x4F:
    case 0x57:
